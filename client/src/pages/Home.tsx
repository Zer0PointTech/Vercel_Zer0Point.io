        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 reveal">
            <Button 
              ...
              onClick={() => window.open('https://calendly.com/najimasri-zer0point/15min', '_blank')}
            >
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button size="lg" className="h-16 px-10 text-xl bg-white text-background hover:bg-gray-200 rounded-none border-0 shadow-xl transition-transform hover:-translate-y-1" onClick={() => window.open('https://calendly.com/najimasri-zer0point/15min', '_blank')}>
              Schedule a call
            </Button>
          </div>
        </div>
